...
ifeq ($(PLATFORM_SDK_VERSION), 29)
  LOCAL_SRC_FILES := BlissLauncher-1.10.2-apiQ-release.apk
else ifeq ($(PLATFORM_SDK_VERSION), 30)
  LOCAL_SRC_FILES := BlissLauncher-1.10.2-apiR-release.apk
else
  LOCAL_SRC_FILES := BlissLauncher-1.10.2-apiS-release.apk
endif
