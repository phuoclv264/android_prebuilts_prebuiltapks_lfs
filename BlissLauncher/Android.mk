...
ifeq ($(PLATFORM_SDK_VERSION), 29)
  LOCAL_SRC_FILES := BlissLauncher-1.14.0-apiQ-release.apk
else ifeq ($(PLATFORM_SDK_VERSION), 30)
  LOCAL_SRC_FILES := BlissLauncher-1.14.0-apiR-release.apk
else
  LOCAL_SRC_FILES := BlissLauncher-1.14.0-apiS-release.apk
endif
